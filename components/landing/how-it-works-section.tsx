      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Proven Core.
            <br />
            <span className="text-background/50">Shaped to Fit.</span>
          </h2>
          <p
            className={`mt-8 max-w-2xl text-lg text-background/60 leading-relaxed transition-all duration-700 delay-100 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
          ...
          <div className="lg:sticky lg:top-32 self-start">
            <div className="border border-background/10 overflow-hidden">
              ...
              <div className="px-6 py-4 border-b border-background/10 flex items-center justify-between">
                ...
                <span className="text-xs font-mono text-background/40">process.md</span>
              </div>
