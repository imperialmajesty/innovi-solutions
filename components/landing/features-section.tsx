...
const features = [
  ...
  },
  {
    ...
    description: "Proven core products — booking systems, operational tools — shaped to your business rules, branding, and integrations.",
    visual: "collab",
  },
  {
    number: "03",
    title: "Data Engineering & Automation",
    description: "Pipelines and workflows that move your data and remove the manual work — reliable, observable, and built to scale.",
    visual: "security",
  },
  {
    number: "04",
    title: "AI Agents",
    description: "Agents that handle queries, documents, and monitoring — so your team focuses on what genuinely needs a human.",
    visual: "ai",
  },
];
  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        const nodeX = Number((100 + Math.cos(angle) * radius).toFixed(3));
        const nodeY = Number((80 + Math.sin(angle) * radius).toFixed(3));
        return (
          <g key={i}>
            {/* Connection line */}
            <line
